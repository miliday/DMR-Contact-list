...
const FILE_NAME = "OPENGD77-MD9600-RT90";
...
Promise.all([
    ...
    Promise.resolve(readCustomContacts('./configuration/OPENGD77-MD9600-RT90.csv', ';'))

]).then(([api, k2, custom]) => {

    const raw = {api, k2, custom}
    const data = dataCombiner(raw, "OPENGD77-MD9600-RT90") // Формат данних: "MD9600-RT90" / "OPENGD77-MD9600-RT90" або "ANYTONE"
